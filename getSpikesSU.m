function out = getSpikesSU(data, chan)
...
% Import spike file
NSE                 = NLX_LoadNSE([data.sdir fname],'FULL',1,[]);           % Import NSE data                                      % Specify baseline firing rate [Hz]
...
for cl = 2:length(cluster)                                                  % Loop through clusters
